...
# --- REPLACEMENT FOR CVZONE (Server Safe) ---
# We define this class locally so we don't need to install 'cvzone' 
# which forces the wrong OpenCV version.
class HandDetector:
    ...
    def findHands(self, img, draw=True, flipType=True):
        ...
        if self.results.multi_hand_landmarks:
            for handType, handLms in zip(self.results.multi_handedness, self.results.multi_hand_landmarks):
                ...
                # Flip logic to match cvzone behavior if needed
                if flipType:
...
class SignPredictor:
    def __init__(self):
        ...
        self.interpreter = Interpreter(model_path='cnn8grps_rad1_model.tflite')
        self.interpreter.allocate_tensors()
        
        self.input_details = self.interpreter.get_input_details()
        self.output_details = self.interpreter.get_output_details()
        
        # CHANGED: Use the local safe HandDetector
        ...
        # REMOVED: self.speak_engine = pyttsx3.init() 
        # CAUSE OF CRASH: Servers have no audio drivers.
    ...
    def speak_fun(self):
        # CHANGED: Do nothing on server. 
        # Return the text to the frontend if you want the browser to speak.
        pass
    ...
    def predict(self, test_image):
        ...
        # --- LOGIC REMAINS EXACTLY THE SAME AS YOUR FILE BELOW THIS LINE ---
        # (I have preserved your exact logic, just removing the cvzone dependency
        # and audio dependency that causes the crash)
